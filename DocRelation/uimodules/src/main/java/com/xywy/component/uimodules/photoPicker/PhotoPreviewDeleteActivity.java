...
public class PhotoPreviewDeleteActivity extends Activity implements ViewPager.OnPageChangeListener, View.OnClickListener {
     ...
     */
    public static void startActivity(Context context, List<PhotoInfo> selectPhotoList, List<PhotoInfo> showPhotoList, int canSelectNum, int position, String fileName) {
        Intent intent = new Intent(context, PhotoPreviewDeleteActivity.class);
        intent.putExtra(SELECT_PHOTO_LIST, (ArrayList)selectPhotoList);
        intent.putExtra(SHOW_PHOTO_LIST, (ArrayList)showPhotoList);
