...
//        helper = new LastTimeDBConnection(ctx);
        helper = LastTimeDBConnection.newInstance(ctx);
    }
    ...
    public static class LastTimeDBConnection extends SQLiteOpenHelper {
        ...
        public static LastTimeDBConnection newInstance(Context context) {
            return new LastTimeDBConnection(context);
        }
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String create_sql = ("CREATE TABLE " + UserSchema.TABLE_NAME) +
                    " (" +
                    "m_uu varchar(50)," +
                    "m_vu varchar(50)," +
                    "m_position integer," +
                    "m_defination varchar(50)," +
                    "primary key (m_uu,m_vu)" +
                    " )";
