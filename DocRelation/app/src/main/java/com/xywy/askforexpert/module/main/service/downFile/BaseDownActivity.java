 ...
 * @2015-6-5下午4:27:06
 */
public class BaseDownActivity extends Activity implements ContentValue {
    ...
    public Intent getServerIntent() {
        Intent i = new Intent(BaseDownActivity.this, DownloadService.class);
    ...
    public void initView() {
        YMApplication app = (YMApplication) BaseDownActivity.this.getApplication();
        setSp(BaseDownActivity.this.getSharedPreferences("config",
                MODE_PRIVATE));
