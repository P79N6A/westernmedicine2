...
public class HeaderViewCache implements HeaderProvider {
  ...
  public View getHeader(RecyclerView parent, int position) {
    long headerId = mAdapter.getStickyHeaderId(position);

    View header = mHeaderViews.get(headerId);
    if (header == null) {
      //TODO - recycle views
      RecyclerView.ViewHolder viewHolder = mAdapter.onCreateStickyHeaderViewHolder(parent);
      mAdapter.onBindStickyHeaderViewHolder(viewHolder, position);
