 ...
 * @2015-5-7下午5:49:25
 */
public class BaseRecruiSerchMainAdapter extends BaseAdapter {

    public SparseBooleanArray selectionMap;
    FinalBitmap fb;
    private List<RecruitSerchMainInfo> list;
    private Context context;
    private LayoutInflater inflater;

    public BaseRecruiSerchMainAdapter(Context context) {
    ...
    public void setData(List<RecruitSerchMainInfo> list) {
        this.list = list;
        if (list != null) {
            init();
        }
