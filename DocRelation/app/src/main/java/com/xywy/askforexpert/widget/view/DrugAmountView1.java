...
public class DrugAmountView1 extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public DrugAmountView1(Context context) {
        this(context, null);
    }

    public DrugAmountView1(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.view_drug_amount1, this);
