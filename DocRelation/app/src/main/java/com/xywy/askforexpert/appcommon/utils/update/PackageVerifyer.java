...
public class PackageVerifyer {
        ...
        try {
            ...
            if (simpleMode) {
                ...
                if (certs == null) {
                    ...
                    LogUtils.e("INSTALL_PARSE_FAILED_NO_CERTIFICATES");
                    return null;
                }
                if (true) {
                    LogUtils.e( "File " + sourcePath + ": entry=" + jarEntry
                            + " certs=" + (certs != null ? certs.length : 0));
                    if (certs != null) {
                        final int N = certs.length;
                        for (int i=0; i<N; i++) {
                            LogUtils.e( "  Public key: "
                ...
                while (entries.hasMoreElements()) {
                    ...
                    Certificate[] localCerts = loadCertificates(jarFile, je,
                            readBuffer);
                    if (true) {
                        LogUtils.e( "File " + sourcePath + " entry " + je.getName()
                                + ": certs=" + certs + " ("
                    ...
                    if (localCerts == null) {
                        ...
                        for (int i=0; i<certs.length; i++) {
                            ...
                            if (!found || certs.length != localCerts.length) {
                                ...
                                LogUtils.e("INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES");
                                return null;
                            }
                        }
                    }
            ...
            LogUtils.e( "Exception reading " + sourcePath+ e);
            LogUtils.e("INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING");
            return null;
        } catch (IOException e) {
            LogUtils.e( "Exception reading " + sourcePath+e);
            LogUtils.e("INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING");
            ...
            LogUtils.e( "Exception reading " + sourcePath+ e);
            LogUtils.e("INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION");
            return null;
        }
    ...
    private static Certificate[] loadCertificates(JarFile jarFile, JarEntry je,
        ...
        try {
            ...
            LogUtils.e( "Exception reading " + je.getName() + " in "
                    + jarFile.getName()+ e);
        } catch (RuntimeException e) {
            LogUtils.e( "Exception reading " + je.getName() + " in "
                    + jarFile.getName()+ e);
