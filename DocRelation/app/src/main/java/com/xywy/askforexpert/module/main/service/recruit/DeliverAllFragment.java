...
import com.xywy.askforexpert.module.main.service.recruit.adapter.BaseRecruitDeliverAdapter;
...
public class DeliverAllFragment extends Fragment implements
    ...
    private BaseRecruitDeliverAdapter adapter;
            ...
            switch (msg.what) {
                case 100:
                    ...
                    if (recrut_info != null & recrut_info.getCode().equals("0")
                        ...
                        adapter = new BaseRecruitDeliverAdapter(getActivity());
                        ...
                        if (recrut_info.getList_first().getList().size() > 0) {
                            ((TextView) getActivity().findViewById(R.id.tv_total1))
                                    .setText("共"
...
//						T.shortToast( "没有更多数据了");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.myresume_second2, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        no_data = (LinearLayout) getActivity().findViewById(R.id.lin_nodata);
        tv_nodata_title = (TextView) getActivity().findViewById(
                R.id.tv_nodata_title);
        tv_nodata_title.setText("暂无投递的职位");
        img_nodata = (ImageView) getActivity().findViewById(R.id.img_nodate);
        ...
        swip = (SwipeRefreshLayout) getActivity().findViewById(R.id.swip_index1);
        ...
        // .findViewById(R.id.list_resume22);
        //
        ...
        getActivity().findViewById(R.id.btn01).setOnClickListener(
                new OnClickListener() {
...
//		MobileAgent.onPause(getActivity());
        StatisticalTools.fragmentOnPause("DeliverAllFragment");
...
//		MobileAgent.onResume(getActivity());
        StatisticalTools.fragmentOnResume("DeliverAllFragment");
    }
