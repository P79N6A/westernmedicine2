 ...
 * @2015-5-7下午5:49:25
 */
public class BaseRecruitDeliverAdapter extends BaseAdapter {
    ...
    public BaseRecruitDeliverAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (list != null) {
            ...
            holder.tv_data.setText(list.get(position).getReturnedtime());
//			fb.display(holder.imageView, list.get(position).getLogo());
            holder.tv_type.setText(list.get(position).getIs_show());
            holder.tv_type.setTextColor(context.getResources().getColor(R.color.impor_number));
