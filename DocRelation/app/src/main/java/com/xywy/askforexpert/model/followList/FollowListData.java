...
public class FollowListData {
    ...
    public void setZdepart(String zdepart) {
        this.zdepart = zdepart;
    }
    ...
    public void setDoc_alltek(String doc_alltek) {
        this.doc_alltek = doc_alltek;
    }
    ...
    public void setHome_open(String home_open) {
        this.home_open = home_open;
    }
    ...
    public void setHome_free(String home_free) {
        this.home_free = home_free;
    }
    ...
    public boolean isFollowed() {
        return followed || (this.relation.equals("2") || this.relation.equals("3"));
    }
