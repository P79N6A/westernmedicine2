...
public class ContactModel extends RealmObject {
    ...
    public ContactBean toContactBean() {
        ...
        contactBean.setUserId(this.userId);
        contactBean.setUserName(this.userName);
        contactBean.setHeadUrl(this.headUrl);
        contactBean.setHxId(this.hxId);
        contactBean.setMaster(this.isMaster);
        contactBean.setMyFriend(this.isMyFriend);
