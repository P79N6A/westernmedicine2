...
public class DragGrid extends GridView {
    ...
    public int getStalePos() {
        return stalePos;
    }

    public void setStalePos(int stalePos) {
    ...
    private void init(Context context) {
        ...
        // 将布局文件中设置的间距dip转为px
        mHorizontalSpacing = DensityUtils.dp2px(mHorizontalSpacing);
    }
