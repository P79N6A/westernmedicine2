...
public class MyPurseGVItemBean {
    private String name;
    private String desc;
    ...
    public MyPurseGVItemBean(String name, String desc, int iconResId, boolean isOpened, int unreadMsgCount) {
        this.name = name;
        this.desc = desc;
    ...
    public MyPurseGVItemBean(String name, String desc, int iconResId, boolean isOpened) {
        this.name = name;
        this.desc = desc;
        this.iconResId = iconResId;
        this.isOpened = isOpened;
