...
public class BaseCommentFistAdapter extends BaseAdapter {
    ...
    public BaseCommentFistAdapter(Context context, String tag) {
    ...
    private class MyOnclick implements OnClickListener {
        ...
        public void onClick(View arg0) {
            if ("commt".equals(type)) {
                CommentInfoActivity.et_sendmmot.setHint("回复"
                        + list.get(position).getDoc().getName() + "的评论");
                ShowKeyboard(CommentInfoActivity.et_sendmmot);
                // String sign =
                // MD5Util.MD5(CommentInfoActivity.et_sendmmot.getText()
    ...
    // fh.post(CommonUrl.Consulting_Url, params, new AjaxCallBack<Object>()
    // {
    // @Override
    // public void onFailure(Throwable t, int errorNo, String strMsg)
    // {
