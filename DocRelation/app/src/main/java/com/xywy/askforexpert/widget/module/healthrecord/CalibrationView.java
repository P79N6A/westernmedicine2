...
public class CalibrationView extends View {
    ...
    //平行于x轴的刻度线，存放用于展示的值
    private List<Float> axisLineValueList = new ArrayList<>();
    ...
    private void drawAxisLine(Canvas canvas) {
        ...
        if (axisLineList != null && axisLineList.size() > 0) {
            ...
            for (int i = 0; i < axisLineList.size(); i++) {
                ...
                paint.setTextSize(DensityUtils.dp2px(10));
                ...
                canvas.drawText(text, previousX, previousY, paint);
            }
        }
    }
    ...
    public void setAxisLineValueList(final List<Float> axisLineValueList) {
