...
public final class RSAUtils
{
    ...
    public static String encodeUserid(String id) {
        ...
        try {
            ...
            // 从文件中得到公钥
            InputStream inPublic = YMApplication.getAppContext().getResources().getAssets()
                    .open("rsa_public_key.pem");
            PublicKey publicKey = RSAUtils.loadPublicKey(inPublic);
            // 加密
            String encodeString = id;
            byte[] encryptByte = RSAUtils.encryptData(encodeString.getBytes(), publicKey);
