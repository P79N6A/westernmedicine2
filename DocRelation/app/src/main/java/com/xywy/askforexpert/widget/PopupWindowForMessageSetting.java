 ...
 *离线消息 stone
 */
public class PopupWindowForMessageSetting extends PopupWindow {
    //列表弹窗的间隔
    ...
    public PopupWindowForMessageSetting(Context context) {
        //设置布局的参数
        this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }

    @SuppressLint("InflateParams")
    public PopupWindowForMessageSetting(Context context, int width, int height) {
