...
public class LastestMedicineRecordInnerItem {
    ...
    public class Drug{
        ...
        public int resId;
        public Drug(String gid,String gsku,int resId,
                    String gname,String specification,String take_rate,
                    String take_time, String take_num,int take_unit,
                    int take_method){
            this.gid = gid;
            this.gsku = gsku;
            this.resId = resId;
