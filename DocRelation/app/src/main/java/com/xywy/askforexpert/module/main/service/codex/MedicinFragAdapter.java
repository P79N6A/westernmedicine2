 ...
 * @2015-5-10下午4:09:34
 */
public class MedicinFragAdapter extends BaseExpandableListAdapter {
    ...
    public MedicinFragAdapter(Context context) {
    ...
    public void setData(List<CodexInfo> group_list) {
    ...
    public Object getChild(int groupPosition, int childPosition) {
        ...
        return group_list.get(groupPosition).getList_second()
                .get(childPosition);
    }
...
//		}
        gholder.txt.setText(group_list.get(groupPosition).getList_second().get(childPosition).getName());
    ...
    public int getChildrenCount(int groupPosition) {
        // TODO Auto-generated method stub
        return group_list.get(groupPosition).getList_second().size();
    }
