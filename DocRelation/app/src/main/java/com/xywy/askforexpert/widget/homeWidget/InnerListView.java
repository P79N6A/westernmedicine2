...
import com.xywy.askforexpert.widget.homeWidget.util.IntegerVariable;
...
//        registerPostDataSetObserver(adapter);
    ...
    private int getListViewScrollY() {
        ...
        List<IntegerVariable> heightsLocal = getHeightsSafely();
        ...
        if (firstVisiblePosition != old_FirstVisiblePosition || lastVisiblePosition != old_LastVisiblePosition) {
            ...
            MagicHeaderUtils.ensureCapacityWithEmptyObject((ArrayList<IntegerVariable>) heightsLocal, lastVisiblePosition + 1, IntegerVariable.class);
     ...
     * (as its name)
     */
    private List<IntegerVariable> ensureEmptyHeaderHeight() {
        if (heights == null) {
            heights = new ArrayList<IntegerVariable>();
        }

        MagicHeaderUtils.ensureCapacityWithEmptyObject((ArrayList<IntegerVariable>)heights, 1, IntegerVariable.class);

        heights.set(0, mEmptyHeaderHeight);
        return heights;
    }

    private List<IntegerVariable> getHeightsSafely() {
        if (heights == null) {
