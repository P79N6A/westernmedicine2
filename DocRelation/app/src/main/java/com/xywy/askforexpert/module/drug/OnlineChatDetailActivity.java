 ...
 * 在线诊室聊天详情页面 stone
 */
public class OnlineChatDetailActivity extends YMBaseActivity implements View.OnClickListener, ChatBottomAdapter.OnItemClickListener, WebSocketImInterface {
...
//    private int chatState = CHAT_STATE_BEGIN;
    ...
    public static void startActivity(Context context, String qid, String patientId, String patientName, boolean visit_end,int visitType) {
        Intent intent = new Intent(context, OnlineChatDetailActivity.class);
...
//            rlvChat.smoothScrollToPosition(chatAdapter.getItemCount() - 1);
    ...
    protected void initView() {
        ...
        chatAdapter = new OnlineConsultChatAdapter(this,false, new MyCallBack() {
        ...
        PromptViewHelper pvHelper = new PromptViewHelper(OnlineChatDetailActivity.this);
        pvHelper.setPromptViewManager(new ChatPromptViewManager(OnlineChatDetailActivity.this, new String[]{"粘贴"}, Location.TOP_LEFT));
        ...
        pvHelper.setOnItemClickListener(new PromptViewHelper.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                if (!mClipboardManager.hasPrimaryClip()) {
                    Toast.makeText(OnlineChatDetailActivity.this,
                    ...
                    for (int i = 0; i < count; ++i) {
                        ...
                        CharSequence str = item
                                .coerceToText(OnlineChatDetailActivity.this);
...
//                    stone 添加忙线提示
        ...
        prescription_rl.setOnClickListener(OnlineChatDetailActivity.this);
...
//                isEnable = true;
//            }
//            bottomItemEntity = new ChatBottomItemEntity(STR_ITEM_PRESCRIPTION, isEnable,
...
//            itemEntityList.add(bottomItemEntity);
            bottomItemEntity = new ChatBottomItemEntity(STR_ITEM_PRESCRIPTION, true,
                    R.drawable.chat_bottom_item_prescription, R.drawable.chat_bottom_item_prescription);
            itemEntityList.add(bottomItemEntity);
...
//            }
    ...
    public void onItemClick(ChatBottomItemEntity entity) {
        ...
        if (entity.getText().equals(STR_ITEM_PRESCRIPTION)) {
            //跳转到处方页面
            startActivityForResult(new Intent(OnlineChatDetailActivity.this,PrescriptionActivity.class).
                    ...
                    putExtra(Constants.INTENT_KEY_DEPARTMENT,prescriptionData.getDoctor_depart()).
...
//            //语音 stone
            ...
            StatisticalTools.eventCount(OnlineChatDetailActivity.this, "voicetotext");
...
//                        post.execute();
    ...
    private void loadMsgList() {
        if (questionId == null || questionId.equals("") || doctorId == null || doctorId.equals("")) {
          ...
          ServiceProvider.getOnlineQuestionMsgList(doctorId, questionId, new Subscriber<OnlineQuestionMsgListRspEntity>()
                        ...
                        if (list != null &&list.size()!=0) {
                            for (int i = 0; i < list.size(); i++) {
                                ...
                                if (list.get(i).getContent() != null
                                    ...
                                    OnlineConsultChatEntity entity = new OnlineConsultChatEntity();
                                    if (i==list.size()-1){
                                        entity.setTitleData(questionMsgListRspEntity.getData());
...
//            loadMsgList();
            ...
            if (entity != null) {
                entity.setDataBean(new OnlineQuestionMsgListRspEntity.DataBean.ListBean());
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.item_popupwindows_Photo:
                    intent = new Intent(OnlineChatDetailActivity.this, PhotoWallActivity.class);
                    startActivity(intent);
                    YMApplication.photoTag = Constants.ONLINE_CHAT;
