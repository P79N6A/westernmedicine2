...
public class PromptView extends View {
    ...
    private int mSingleWidth = DensityUtil.dip2px(55), mSingleHeight = DensityUtil.dip2px(30);
    private int mLineWidth = 1;
    private int mArrowWidth = DensityUtil.dip2px(16), mArrowHeight = DensityUtil.dip2px(12);
    ...
    private void init() {
        ...
        mPaint.setTextSize(DensityUtil.dip2px(16));
    }
