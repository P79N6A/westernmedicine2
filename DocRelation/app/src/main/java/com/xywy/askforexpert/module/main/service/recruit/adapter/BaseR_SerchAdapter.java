...
public class BaseR_SerchAdapter extends BaseAdapter {
    ...
    public BaseR_SerchAdapter(Context context,
                              List<HashMap<String, String>> list, String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (list != null) {
            ...
            holder.textView.setText(list.get(position).get("description"));
