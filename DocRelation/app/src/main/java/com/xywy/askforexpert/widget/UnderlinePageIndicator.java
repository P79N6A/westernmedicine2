...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultSelectedColor = res.getColor(R.color.color_00c8aa);
        final int defaultUnderLineHeight = 1;
        ...
        setUnderLineHeight(a.getInteger(R.styleable.UnderlinePageIndicator_underLineHeight, defaultUnderLineHeight));
