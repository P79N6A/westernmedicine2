package com.xywy.askforexpert.module.message.imgroup.view;
...
public class FrontViewToMove {
    ...
    private int xToMove = DensityUtils.dp2px(84);// 视图所要被移动的距离，默认84dp

    private FrontViewMovedListener frontViewMovedListener;
     ...
     */
    public FrontViewToMove(View frontView, ListView listView, FrontViewMovedListener frontViewMovedListener) {
        this.frontView = frontView;
        this.listView = listView;
        this.frontViewMovedListener = frontViewMovedListener;
        moveListener();
    }
     ...
     */
    private static void generateRevealAnimateSlowly(final View view, float deltaX) {
        int moveTo = (int) deltaX;
        animate(view).translationX(moveTo).setDuration(200)
    ...
    private void setXToMove(int xToMove) {
        this.xToMove = DensityUtils.dp2px(xToMove);
    }

    public void moveBack() {
        generateRevealAnimateSlowly(frontView, 0);
        hasMoved = false;
    }
    ...
    public void moveListener() {
        frontView.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (null != PinyinBaseAdapter.lastMovedView) {
                    LogUtils.d("moveBack");
                    //上次滑动的View 回到初始状态
                    PinyinBaseAdapter.lastMovedView.moveBack();
                }
                    ...
                    case MotionEvent.ACTION_UP: {
                        ...
                        if (swap) {
                            if (!hasMoved) {
                                ...
                                hasMoved = true;
                                frontViewMovedListener.moved(FrontViewToMove.this);
                            } else {
