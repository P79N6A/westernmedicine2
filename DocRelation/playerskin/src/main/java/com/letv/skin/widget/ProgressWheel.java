...
//    parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.ProgressWheel));
    parseAttributes(context.obtainStyledAttributes(attrs, ReUtils.getStyleableArray(context, "ProgressWheel")));
    setAnimationEnabled();
  }
...
//        circleRadius = (int) a.getDimension(R.styleable.ProgressWheel_matProg_circleRadius, circleRadius);
        circleRadius = (int) a.getDimension(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_circleRadius"), circleRadius);

//        fillRadius = a.getBoolean(R.styleable.ProgressWheel_matProg_fillRadius, false);
        fillRadius = a.getBoolean(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_fillRadius"), false);

//        barWidth = (int) a.getDimension(R.styleable.ProgressWheel_matProg_barWidth, barWidth);
        barWidth = (int) a.getDimension(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_barWidth"), barWidth);

//        rimWidth = (int) a.getDimension(R.styleable.ProgressWheel_matProg_rimWidth, rimWidth);
        rimWidth = (int) a.getDimension(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_rimWidth"), rimWidth);

//        float baseSpinSpeed = a.getFloat(R.styleable.ProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        float baseSpinSpeed = a.getFloat(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_spinSpeed"), spinSpeed / 360.0f);
        
        spinSpeed = baseSpinSpeed * 360;

//        barSpinCycleTime = a.getInt(R.styleable.ProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);
        barSpinCycleTime = a.getInt(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_barSpinCycleTime"), (int) barSpinCycleTime);

//        barColor = a.getColor(R.styleable.ProgressWheel_matProg_barColor, barColor);
        barColor = a.getColor(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_barColor"), barColor);

//        rimColor = a.getColor(R.styleable.ProgressWheel_matProg_rimColor, rimColor);
        rimColor = a.getColor(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_rimColor"), rimColor);

//        linearProgress = a.getBoolean(R.styleable.ProgressWheel_matProg_linearProgress, false);
        linearProgress = a.getBoolean(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_linearProgress"), false);

//        if (a.getBoolean(R.styleable.ProgressWheel_matProg_progressIndeterminate, false)) {
//            spin();
//        }
        if (a.getBoolean(ReUtils.getStyleable(getContext(), "ProgressWheel_matProg_progressIndeterminate"), false)) {
            spin();
        }
