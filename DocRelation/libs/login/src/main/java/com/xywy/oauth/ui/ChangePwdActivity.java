...
public class ChangePwdActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        titleName.setText(R.string.changepwd);
    ...
    class FindPasswordResponse implements IDataResponse {
        ...
        public void onResponse(BaseData obj) {
            if (obj != null) {
                ...
                boolean noError = DataRequestTool.noError(ChangePwdActivity.this, obj, false);
                if (noError) {
    ...
    class GetCodeResponse implements IDataResponse {
        ...
        public void onResponse(BaseData obj) {
            if (obj != null) {
                boolean isSucess = DataRequestTool.noError(ChangePwdActivity.this, obj, false);
                if (isSucess) {
