...
-keep class com.xywy.livevideo.LiveManager {
    *;
}
-keep class com.xywy.livevideo.LiveConfig {
    *;
}
-keep class com.xywy.livevideo.LiveConfig$* {
    *;
...
-keep class com.xywy.livevideo.RechargeType {
    *;
}
-keep class com.xywy.livevideo.common_interface.IDataRequest {
    *;
}
