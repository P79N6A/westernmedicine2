...
public class TestConstants {
     ...
     * 绑定手机
     */
    public final static String api_bind_value = "796";
    ...
    public static final String INTENT_PARAM_CON = "con";//给图文咨询成功界面传症状描述
     ...
     * 问题详情
     */
    public final static String QUESTION_DETAIL_API_VALUE = "814";
