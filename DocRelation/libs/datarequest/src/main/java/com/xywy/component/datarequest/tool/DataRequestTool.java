...
//                .build();
    ...
    public static DataRequestWrapper post(String url, String method, final Map<String, String> bundle, final Map<String, String> httpHeader, final IDataResponse iHttpResponse,
                                          Type type, String flag) {
//
//        DataRequestWrapper wrapper = new DataRequestWrapper.Builder(DataRequestWrapper.DataRequestMethod.GET,
//                builder.toString(), iHttpResponse)
...
//                .build();
    ...
    public static DataRequestWrapper maxleap(String url, String method, final Map<String, String> bundle, final Map<String, String> httpHeader, final IDataResponse iHttpResponse,
                                          Type type, String flag) {
//
//        DataRequestWrapper wrapper = new DataRequestWrapper.Builder(DataRequestWrapper.DataRequestMethod.GET,
//                builder.toString(), iHttpResponse)
...
//                .build();
        ...
        DataRequestWrapper wrapper = new DataRequestWrapper.Builder(DataRequestWrapper.DataRequestMethod.MAXLEAP, url, iHttpResponse)
                .urlMethod(method)
                .param(bundle)
                .httpHeader(httpHeader)
                .type(type)
