...
public abstract class XywySuperBaseActivity extends AppCompatActivity implements BaseActivityInterface {
    ...
    private void initSuperUI() {
        ...
        titleBarBuilder = new TitleBarBuilder(XywySuperBaseActivity.this, toolbar);
        ll_root= (LinearLayout) findViewById(R.id.ll_root);
        if (layoutInflater == null) {
            layoutInflater = LayoutInflater.from(XywySuperBaseActivity.this);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
            KeyBoardUtils.closeKeyboardWhenCurFocusIsNotEt(XywySuperBaseActivity.this, motionEvent);
        }
