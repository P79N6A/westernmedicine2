...
import com.xywy.uilibrary.utils.DensityUtils;
...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommonItemDecoration(Context context, int colorResId, float dividerWidh) {

        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG) ;
        mPaint.setColor(context.getResources().getColor(colorResId));
         //设置填充
        mPaint.setStyle(Paint.Style.FILL);
        lineWidth=dip2px(dividerWidh);
    }
