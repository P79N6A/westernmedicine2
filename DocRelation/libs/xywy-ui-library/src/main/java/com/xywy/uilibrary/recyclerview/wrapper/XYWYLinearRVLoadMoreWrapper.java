...
public class XYWYLinearRVLoadMoreWrapper<T> extends LoadMoreWrapper<T> {
    ...
    public void loadDataFailed() {
        loadMoreAndNoMoreDataCallback.onShowLoadFailed(mLoadMoreView);
    }

    protected XYWYLinearRVLoadMoreWrapper setLoadMoreView(View loadMoreView, LoadMoreAndNoMoreDataCallback loadMoreAndNoMoreDataCallback) {
        this.loadMoreAndNoMoreDataCallback = loadMoreAndNoMoreDataCallback;
        return (XYWYLinearRVLoadMoreWrapper) setLoadMoreView(loadMoreView);
    }

    public XYWYLinearRVLoadMoreWrapper setLoadMoreView(int layoutId, LoadMoreAndNoMoreDataCallback loadMoreAndNoMoreDataCallback) {
        this.loadMoreAndNoMoreDataCallback = loadMoreAndNoMoreDataCallback;
        return (XYWYLinearRVLoadMoreWrapper) setLoadMoreView(layoutId);
    }
    ...
    protected void setDefaultLoadMoreView(Context context) {
        ...
        final View loadMoreView = LayoutInflater.from(context).inflate(R.layout.loading_more, recyclerView, false);
