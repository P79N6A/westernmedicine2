package com.xywy.uilibrary.dialog.bottompopupdialog;
...
public class BottomBtnPopupWindow extends AbsPopupWindow {
    ...
    public static class Builder {
        ...
        public BottomBtnPopupWindow build(Context context) {
            ...
            if (isHasCancel) {
                dialogBtnItemList.add(new DialogBtnItem("取消", DialogBtnItem.NumberType.SINGLE, null).setCancleItem(true));
            }
